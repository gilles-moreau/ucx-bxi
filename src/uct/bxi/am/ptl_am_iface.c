...
static void uct_ptl_am_handle_failure(uct_ptl_iface_t *ptl_iface,
  ...
  self->super.conn_state = UCT_PTL_EP_CONN_PT_DISABLED;
  ...
  static ucs_status_t uct_ptl_am_iface_handle_ev(uct_ptl_iface_t * iface,
    ...
    ucs_info("PORTALS: EQS EVENT '%s' idx=%d, "
             ...
             ev->user_ptr, ev->start, (int)(ev->start - block->start),
             ev->remote_offset);
    ...
    case PTL_EVENT_PT_DISABLED:
      uct_ptl_am_handle_failure(iface, 
    rc = UCS_ERR_IO_ERROR;
    break;
  default:
    break;
  ...
  ucs_status_t uct_ptl_am_iface_flush(uct_iface_h tl_iface, unsigned flags,
    ...
    uct_ptl_am_iface_t *ptl_iface =
        ucs_derived_of(tl_iface, uct_ptl_am_iface_t);
  ...
  static ucs_status_t uct_ptl_am_iface_get_addr(uct_iface_h tl_iface,
    ...
    uct_ptl_am_md_t *md =
        ucs_derived_of(iface->super.super.md, uct_ptl_am_md_t);
  ...
  static UCS_CLASS_INIT_FUNC(
      uct_ptl_am_iface_t, uct_md_h tl_md, uct_worker_h worker,
