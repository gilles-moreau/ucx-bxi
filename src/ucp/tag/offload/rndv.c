...
static void ucp_tag_rndv_offload_completion(uct_completion_t *uct_comp)
{
  ucp_request_t *req =
                               ...
                               uct_iov_t                     *iov)
{
  ...
  rndv_op = uct_ep_tag_rndv_zcopy(
          ...
          req->send.msg_proto.tag, &rndv_hdr, sizeof(rndv_hdr), iov, 1, flags,
                 ...
                 uct_pending_req_t *self)
{
  ...
  return ucp_proto_zcopy_single_progress(
          ...
          ucp_tag_rndv_offload_send_func, NULL, ucp_tag_rndv_offload_completion,
          ucp_tag_rndv_offload_request_init);
}
...
ucp_tag_rndv_offload_sw_proto_probe(const ucp_proto_init_params_t *init_params)
{
  ...
  ucp_proto_rndv_ctrl_init_params_t params  = {
         ...
         */
           .super.max_frag_offs =
                  ucs_offsetof(uct_iface_attr_t, cap.tag.eager.max_short),
